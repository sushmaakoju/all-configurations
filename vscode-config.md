### Settings.json (Default)
{
	...
	// Configure settings to be overridden for the scala language.
	"[scala]":  {
		"editor.suggestSelection": "first",
	...
	"interactiveSession.editor.fontFamily": "default",
	...
	// When typing a '{' in a string, automatically prefix the string with an 'f'. Requires the `pylanceLspClientEnabled` setting to be true.
	...
	// Use sync server mode [Experimental].
	...
	// Use LSP Client owned by Pylance [Experimental]. Requires the prerelease version of the Python Extension to be installed.
	"python.analysis.pylanceLspClientEnabled": false,
	...
	// When this option is enabled, for each method that has implicit arguments they are displayed as additional decorations.
	"metals.showImplicitArguments": false,

	// When this option is enabled, each implicit method and class is displayed as additional decorations at the usage site.
	"metals.showImplicitConversionsAndClasses": false,

	// When this option is enabled, for each method that have inferred types that are not explicitely specified they are displayed as additional decorations.
	"metals.showInferredType": false,

	// Once in a day, notify if there are new server releases (including snapshots)
	...
	// Automatically open a new integrated terminal and initialise the Scala interpreter upon opening a .scala file.
	"interactiveScala.autoStart": true,

	// Here you can provide a path (and custom arguments) to a Scala interpreter REPL. If you want to run the interpreter with flags or parameters, you can also specify it here. E.g. write `scala` to use a system-wide installation of Scala or write `sbt console` to use the SBT interpreter. You can also preload a file, example: `scala -i Test.scala`
	"interactiveScala.interpreter": "scala",

	// Provide a list of jar-files to be required upon start of the REPL.
